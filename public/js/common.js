require = function e(t, n, r) {
    ...
    13: [function(e, t, n) {
        var r = e("jquery"),
            ...
            a = e("./init-footer"),
            s = e("./track-click"),
            u = e("./scroll-to-element");
        t.exports = function() {
            i(), o(), a(), window.trackClick = s, window.scrollToElement = u, r(function() {
                r(":root").addClass("is-ready")
            })
        }
    }, {
        "./detect-touch": 10,
    ...
    12: [function(e, t, n) {
        var r = e("jquery");
        t.exports = function() {
            r(document).on("click touchstart", ".open-menu", function(e) {
                e.preventDefault(), r(":root").addClass("is-opened"), r("footer ~ nav a").focus()
            }).on("click touchstart", ".close-menu", function(e) {
                e.preventDefault(), r(":root").removeClass("is-opened")
            })
        }
    }, {
        jquery: 35
    ...
    11: [function(e, t, n) {
        var r = e("jquery"),
            i = e("./scroll-to-element");
        t.exports = function() {
            r(document).on("click", ".legal-go", function(e) {
                var t = r(".legal-block");
                if (t.length) {
                    var n = this.hash;
                    t.find(".filter a").each(function() {
                        this.hash === n && (r(this).click(), i("body"))
                    })
                }
            })
        }
    ...
    28: [function(e, t, n) {
        ...
        t.exports = function(e, t, n) {
            e = r(e), r("html, body").animate({
                scrollTop: e.offset().top + (n ? e.height() / 2 - r(window).height() / 2 : 0)
            }, t)
        }
    }, {
        jquery: 35
    ...
    10: [function(e, t, n) {
        ...
        t.exports = function() {
            ...
            r(":root").addClass(e ? "is-touch" : "no-touch")
        }
    }, {
        jquery: 35
    }],
    31: [function(e, t, n) {
        t.exports = function(e) {
            ga("send", "event", "User Interaction", "Click", e)
        }
    }, {}],
    14: [function(e, t, n) {
        var r = e("jquery"),
            i = e("./progress").progressForValueInRange,
            o = !1;
        t.exports = function() {
            function e() {
                t.forEach(function(e) {
                    var t = i(this.wrapperHeight - this.y, e[0].offsetTop, e[0].offsetTop + e[0].offsetHeight);
                    e.progress !== t && (e.progress = t, e.trigger("screen-progress", {
                        scroll: this,
                        progress: t
                    }))
                }, this)
            ...
            if (!o) {
                o = !0;
                var t = r("section").toArray().map(function(e) {
                    return r(e)
                });
                if (t && t.length) {
                    var n = function() {
                        var t = document.querySelector("html"),
                            ...
                            o = null;
                        return function() {
                            var r = -(t.scrollTop || i[0].scrollTop);
                            if (r === o) return window.requestAnimationFrame(n);
                            e.call({
                                wrapperHeight: i.height(),
                                y: r
                            }), o = r, window.requestAnimationFrame(n)
                        }
                    }();
        ...
        ! function(e, n) {
            ...
            function g(e, t, n, r) {
                var i, o = 1,
                    ...
                    l = (de.cssNumber[t] || "px" !== c && +u) && Me.exec(de.css(e, t));
                if (l && l[3] !== c) {
                    c = c || l[3], n = n || [], l = +u || 1;
                    do {
                        l /= o = o || ".5", de.style(e, t, l + c)
                    } while (o !== (o = s() / u) && 1 !== o && --a)
                }
            ...
            function b(e, t, n, r, i) {
                ...
                for (f.textContent = "", d = 0; o = p[d++];)
                    ...
                    else if (c = de.contains(o.ownerDocument, o), a = y(f.appendChild(o), "script"), c && x(a), n)
            ...
            function A(e, t, r, i) {
                ...
                if (p && (o = b(t, e[0].ownerDocument, !1, e, i), a = o.firstChild, 1 === o.childNodes.length && (o = a), a || i)) {
                    for (u = (s = de.map(y(o, "script"), j)).length; f < p; f++) c = o, f !== d && (c = de.clone(c, !0, !0), u && de.merge(s, y(c, "script"))), r.call(e[f], c, f);
                    if (u)
                        for (l = s[s.length - 1].ownerDocument, de.map(s, S), f = 0; f < u; f++) c = s[f], Ue.test(c.type || "") && !He.access(c, "globalEval") && de.contains(l, c) && (c.src ? de._evalUrl && de._evalUrl(c.src) : n(c.textContent.replace(nt, ""), l))
                }
                return e
            }
            ...
            function U(e, t, n) {
                var r, i, o = 0,
                    ...
                    u = function() {
                        if (i) return !1;
                        for (var t = pt || $(), n = Math.max(0, c.startTime + c.duration - t), r = 1 - (n / c.duration || 0), o = 0, a = c.tweens.length; o < a; o++) c.tweens[o].run(r);
                ...
                for (z(l, c.opts.specialEasing); o < a; o++)
                    if (r = U.prefilters[o].call(c, e, l, c.opts)) return de.isFunction(r.stop) && (de._queueHooks(c.elem, c.opts.queue).stop = de.proxy(r.stop, r)), r;
                return de.map(l, _, c), de.isFunction(c.opts.start) && c.opts.start.call(e, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), de.fx.timer(de.extend(u, {
                    elem: e,
                    anim: c,
                    queue: c.opts.queue
                })), c
            ...
            de.fn = de.prototype = {
                ...
                for ("boolean" == typeof a && (c = a, a = arguments[s] || {}, s++), "object" == typeof a || de.isFunction(a) || (a = {}), s === u && (a = this, s--); s < u; s++)
                    if (null != (e = arguments[s]))
                        for (t in e) n = a[t], a !== (r = e[t]) && (c && r && (de.isPlainObject(r) || (i = Array.isArray(r))) ? (i ? (i = !1, o = n && Array.isArray(n) ? n : []) : o = n && de.isPlainObject(n) ? n : {}, a[t] = de.extend(c, o, r)) : void 0 !== r && (a[t] = r));
                return a
            }, de.extend({
            ...
            var ye = function(e) {
                    ...
                    if (!r && ((t ? t.ownerDocument || t : I) !== q && A(t), t = t || q, H)) {
                        ...
                        if (b.qsa && !z[e + " "] && (!F || !F.test(e))) {
                            if (1 !== h) d = t, p = e;
                                ...
                                for ((s = t.getAttribute("id")) ? s = s.replace(xe, be) : t.setAttribute("id", s = M), o = (l = k(e)).length; o--;) l[o] = "#" + s + " " + f(l[o]);
                ...
                function v(e, t, n, i, o, a) {
                    return i && !i[M] && (i = v(i)), o && !o[M] && (o = v(o, a)), r(function(r, a, s, u) {
                        var c, l, f, p = [],
                            ...
                            x = n ? o || (r ? e : v || i) ? [] : a : y;
                        if (n && n(y, x, s, u), i)
                            for (c = g(x, d), i(c, [], s, u), l = c.length; l--;)(f = c[l]) && (x[d[l]] = !(y[d[l]] = f));
                        if (r) {
                            if (o || e) {
                                if (o) {
                    ...
                    var i = n.length > 0,
                        ...
                        a = function(r, a, s, u, c) {
                            var l, f, p, d = 0,
                                ...
                                T = x.length;
                            for (c && (S = a === q || a || c); h !== T && null != (l = x[h]); h++) {
                                if (o && l) {
                                    for (f = 0, a || l.ownerDocument === q || (A(l), s = !H); p = e[f++];)
                                        if (p(l, a || q, s)) {
                                            u.push(l);
                                            break
                                        }
                ...
                var x, b, w, T, C, k, E, j, S, N, D, A, q, L, H, F, O, P, R, M = "sizzle" + 1 * new Date,
                    I = e.document,
                    W = 0,
                    $ = 0,
                    B = n(),
                ...
                b = t.support = {}, C = t.isXML = function(e) {
                    ...
                    return r !== q && 9 === r.nodeType && r.documentElement ? (q = r, L = q.documentElement, H = !C(q), I !== q && (n = q.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", we, !1) : n.attachEvent && n.attachEvent("onunload", we)), b.attributes = i(function(e) {
                        ...
                        return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !b.sortDetached && t.compareDocumentPosition(e) === n ? e === q || e.ownerDocument === I && R(I, e) ? -1 : t === q || t.ownerDocument === I && R(I, t) ? 1 : N ? K(N, e) - K(N, t) : 0 : 4 & n ? -1 : 1)
                    } : function(e, t) {
                        if (e === t) return D = !0, 0;
                        var n, r = 0,
                            i = e.parentNode,
                    ...
                    var n = w.attrHandle[t.toLowerCase()],
                        r = n && X.call(w.attrHandle, t.toLowerCase()) ? n(e, t, !H) : void 0;
                    ...
                    var t, n = [],
                        r = 0,
                        i = 0;
                    if (D = !b.detectDuplicates, N = !b.sortStable && e.slice(0), e.sort(U), D) {
                            ...
                            return 1 === r && 0 === i ? function(e) {
                                ...
                                if (v) {
                                    ...
                                    if (h = [a ? v.firstChild : v.lastChild], a && y) {
                                        for (x = (d = (c = (l = (f = (p = v)[M] || (p[M] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === W && c[1]) && c[2], p = d && v.childNodes[d]; p = ++d && p && p[g] || (x = d = 0) || h.pop();)
                                            if (1 === p.nodeType && ++x && p === t) {
                                                l[e] = [W, d, x];
                                                break
                                            }
                                    } else if (y && (x = d = (c = (l = (f = (p = t)[M] || (p[M] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === W && c[1]), !1 === x)
                                        for (;
                                            (p = ++d && p && p[g] || (x = d = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== m : 1 !== p.nodeType) || !++x || (y && ((l = (f = p[M] || (p[M] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] = [W, x]), p !== t)););
                ...
                return l.prototype = w.filters = w.pseudos, w.setFilters = new l, k = t.tokenize = function(e, n) {
                    ...
                    var n, r = [],
                        ...
                        o = z[e + " "];
                    if (!o) {
                        for (t || (t = k(e)), n = t.length; n--;)(o = m(t[n]))[M] ? r.push(o) : i.push(o);
                ...
                }, b.sortStable = M.split("").sort(U).join("") === M, b.detectDuplicates = !!D, A(), b.sortDetached = i(function(e) {
            ...
            de.fn.extend({
                ...
                de.fn[e] = function(n, r) {
                    ...
                    return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (i = de.filter(r, i)), this.length > 1 && (Se[e] || de.uniqueSort(i), je.test(e) && i.reverse()), this.pushStack(i)
                }
            });
            var Ne = /[^\x20\t\r\n\f]+/g;
            de.Callbacks = function(e) {
                        ...
                        i = {
                            ...
                            then: function(t, r, i) {
                                        ...
                                        var s = this,
                                            ...
                                            f = function() {
                                                ...
                                                if (!(t < a)) {
                                                    ...
                                                    f = e && ("object" == typeof e || "function" == typeof e) && e.then, de.isFunction(f) ? i ? f.call(e, o(a, n, u, i), o(a, n, c, i)) : (a++, f.call(e, o(a, n, u, i), o(a, n, c, i), o(a, n, u, n.notifyWith))) : (r !== u && (s = void 0, l = [e]), (i || n.resolveWith)(s, l))
                                                }
                                            },
                                            p = i ? f : function() {
                                                try {
                                                    ...
                                                    de.Deferred.exceptionHook && de.Deferred.exceptionHook(e, p.stackTrace), t + 1 >= a && (r !== c && (s = void 0, l = [e]), n.rejectWith(s, l))
                                                }
                                            };
                                ...
                                return de.Deferred(function(e) {
                                    n[0][3].add(o(0, e, de.isFunction(i) ? i : u, e.notifyWith)), n[1][3].add(o(0, e, de.isFunction(t) ? t : u)), n[2][3].add(o(0, e, de.isFunction(r) ? r : c))
                                }).promise()
                            },
                            promise: function(e) {
                ...
                when: function(e) {
                    ...
                    if (t <= 1 && (l(e, o.done(a(n)).resolve, o.reject, !t), "pending" === o.state() || de.isFunction(i[n] && i[n].then))) return o.then();
            ...
            p.uid = 1, p.prototype = {
                ...
                remove: function(e, t) {
                    ...
                    if (void 0 !== r) {
                        if (void 0 !== t) {
                            n = (t = Array.isArray(t) ? t.map(de.camelCase) : (t = de.camelCase(t)) in r ? [t] : t.match(Ne) || []).length;
                            for (; n--;) delete r[t[n]]
            ...
            de.event = {
                ...
                add: function(e, t, n, r, i) {
                    var o, a, s, u, c, l, f, p, d, h, g, v = He.get(e);
                    if (v)
                        for (n.handler && (n = (o = n).handler, i = o.selector), i && de.find.matchesSelector(Ge, i), n.guid || (n.guid = de.guid++), (u = v.events) || (u = v.events = {}), (a = v.handle) || (a = v.handle = function(t) {
                            ...
                            }), c = (t = (t || "").match(Ne) || [""]).length; c--;) d = g = (s = Je.exec(t[c]) || [])[1], h = (s[2] || "").split(".").sort(), d && (f = de.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = de.event.special[d] || {}, l = de.extend({
                            type: d,
                            origType: g,
                            data: r,
                            handler: n,
                            ...
                            namespace: h.join(".")
                        }, o), (p = u[d]) || ((p = u[d] = []).delegateCount = 0, f.setup && !1 !== f.setup.call(e, r, h, a) || e.addEventListener && e.addEventListener(d, a)), f.add && (f.add.call(e, l), l.handler.guid || (l.handler.guid = n.guid)), i ? p.splice(p.delegateCount++, 0, l) : p.push(l), de.event.global[d] = !0)
                },
                remove: function(e, t, n, r, i) {
                    var o, a, s, u, c, l, f, p, d, h, g, v = He.hasData(e) && He.get(e);
                    if (v && (u = v.events)) {
                        for (c = (t = (t || "").match(Ne) || [""]).length; c--;)
                            if (s = Je.exec(t[c]) || [], d = g = s[1], h = (s[2] || "").split(".").sort(), d) {
                                for (f = de.event.special[d] || {}, p = u[d = (r ? f.delegateType : f.bindType) || d] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = o = p.length; o--;) l = p[o], !i && g !== l.origType || n && n.guid !== l.guid || s && !s.test(l.namespace) || r && r !== l.selector && ("**" !== r || !l.selector) || (p.splice(o, 1), l.selector && p.delegateCount--, f.remove && f.remove.call(e, l));
                    ...
                    if (u && c.nodeType && !("click" === e.type && e.button >= 1))
                        for (; c !== this; c = c.parentNode || this)
                            if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                                for (o = [], a = {}, n = 0; n < u; n++) void 0 === a[i = (r = t[n]).selector + " "] && (a[i] = r.needsContext ? de(i, this).index(c) > -1 : de.find(i, this, null, [c]).length), a[i] && o.push(r);
                                o.length && s.push({
                                    elem: c,
                                    handlers: o
                                })
            ...
            de.extend({
                ...
                clone: function(e, t, n) {
                    ...
                    if (!(pe.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || de.isXMLDoc(e)))
                        for (a = y(s), r = 0, i = (o = y(e)).length; r < i; r++) D(o[r], a[r]);
                    if (t)
                        if (n)
                            for (o = o || y(e), a = a || y(s), r = 0, i = o.length; r < i; r++) N(o[r], a[r]);
                        else N(e, s);
                ...
                style: function(e, t, n, r) {
                    if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                        var i, o, a, s = de.camelCase(t),
                            u = st.test(t),
                            c = e.style;
                        if (u || (t = O(s)), a = de.cssHooks[t] || de.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (i = a.get(e, !1, r)) ? i : c[t];
                        "string" == (o = typeof n) && (i = Me.exec(n)) && i[1] && (n = g(e, t, i), o = "number"), null != n && n === n && ("number" === o && (n += i && i[3] || (de.cssNumber[s] ? "" : "px")), pe.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, r)) || (u ? c.setProperty(t, n) : c[t] = n))
                    }
                },
                css: function(e, t, n, r) {
                    var i, o, a, s = de.camelCase(t);
                    return st.test(t) || (t = O(s)), (a = de.cssHooks[t] || de.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = L(e, t, r)), "normal" === i && t in ct && (i = ct[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
                }
            ...
            de.Animation = de.extend(U, {
                    ...
                    prefilters: [function(e, t, n) {
                        ...
                        if ((u = !de.isEmptyObject(t)) || !de.isEmptyObject(d)) {
                            f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (c = v && v.display) && (c = He.get(e, "display")), "none" === (l = de.css(e, "display")) && (c ? l = c : (m([e], !0), c = e.style.display || c, l = de.css(e, "display"), m([e]))), ("inline" === l || "inline-block" === l && null != c) && "none" === de.css(e, "float") && (u || (p.done(function() {
                                h.display = c
            ...
            de.extend(de.event, {
                trigger: function(t, n, r, i) {
                    ...
                    if (a = s = r = r || te, 3 !== r.nodeType && 8 !== r.nodeType && !wt.test(d + de.event.triggered) && (d.indexOf(".") > -1 && (d = (h = d.split(".")).shift(), h.sort()), c = d.indexOf(":") < 0 && "on" + d, t = t[de.expando] ? t : new de.Event(d, "object" == typeof t && t), t.isTrigger = i ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : de.makeArray(n, [t]), f = de.event.special[d] || {}, i || !f.trigger || !1 !== f.trigger.apply(r, n))) {
                        ...
                        for (o = 0;
                            (a = p[o++]) && !t.isPropagationStopped();) t.type = o > 1 ? u : f.bindType || d, (l = (He.get(a, "events") || {})[t.type] && He.get(a, "handle")) && l.apply(a, n), (l = c && a[c]) && l.apply && Le(a) && (t.result = l.apply(a, n), !1 === t.result && t.preventDefault());
                        return t.type = d, i || t.isDefaultPrevented() || f._default && !1 !== f._default.apply(p.pop(), n) || !Le(r) || c && de.isFunction(r[d]) && !de.isWindow(r) && ((s = r[c]) && (r[c] = null), de.event.triggered = d, r[d](), de.event.triggered = void 0, s && (r[c] = s)), t.result
                    }
                },
            ...
            de.param = function(e, t) {
                ...
                serializeArray: function() {
                    return this.map(function() {
                        ...
                        var e = this.type;
                        return this.name && !de(this).is(":disabled") && Nt.test(this.nodeName) && !St.test(e) && (this.checked || !_e.test(e))
                    }).map(function(e, t) {
                        var n = de(this).val();
            ...
            Mt.href = Tt.href, de.extend({
                ...
                ajax: function(t, n) {
                    ...
                    if (m.promise(C), h.url = ((t || h.url || Tt.href) + "").replace(Ft, Tt.protocol + "//"), h.type = n.method || n.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(Ne) || [""], null == h.crossDomain) {
            ...
            de.ajaxSetup({
                ...
                if (s || "jsonp" === t.dataTypes[0]) return i = t.jsonpCallback = de.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(Bt, "$1" + i) : !1 !== t.jsonp && (t.url += (kt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function() {
                    return a || de.error(i + " was not called"), a[0]
                }, t.dataTypes[0] = "json", o = e[i], e[i] = function() {
                    a = arguments
                }, r.always(function() {
                    void 0 === o ? de(e).removeProp(i) : e[i] = o, t[i] && (t.jsonpCallback = n.jsonpCallback, $t.push(i)), a && de.isFunction(o) && o(a[0]), a = o = void 0
                }), "script"
                ...
                setOffset: function(e, t, n) {
                    var r, i, o, a, s, u, c = de.css(e, "position"),
                        l = de(e),
                        f = {};
                    "static" === c && (e.style.position = "relative"), s = l.offset(), o = de.css(e, "top"), u = de.css(e, "left"), ("absolute" === c || "fixed" === c) && (o + u).indexOf("auto") > -1 ? (a = (r = l.position()).top, i = r.left) : (a = parseFloat(o) || 0, i = parseFloat(u) || 0), de.isFunction(t) && (t = t.call(e, n, de.extend({}, s))), null != t.top && (f.top = t.top - s.top + a), null != t.left && (f.left = t.left - s.left + i), "using" in t ? t.using.call(e, f) : l.css(f)
                }
            }, de.fn.extend({
                offset: function(e) {
    ...
    26: [function(e, t, n) {
        ...
        n.clampedProgress = r, n.progressForValueInRange = i, n.transitionForProgressInRange = function(e, t, n) {
            return t + (n - t) * e
        }, n.bgProgressFn = function(e, t) {
            return +r(t ? i(e, 1, .5) : i(e < .5 || e > 1.3 ? e : 1, e < .5 ? .3 : e > 1.3 ? 1.5 : 0, e < .5 ? .5 : e > 1.3 ? 1.3 : 1)).toFixed(1)
        }
    }, {}]
}, {}, []);